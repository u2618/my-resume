...
\mainbar{
    ...
    \cvevent{Fighting the Joker}{Funded by Gotham City Super Hero Department}{Jan 2018 -- Dez 2021}{} %by now, you get the idea behind cvevents
    
    \divider
    
    \cvevent{Another Project}{Funded by Gotham City}{Sometime}{}
    
    \divider
    
    \cvevent{And another one}{Funded by Gotham City}{Sometime}{}
